...
class TestGreeting(TestCase):
    ...
    def test_greeting_2(self):
        ...
        for hour, grt in test_data:
            # subTest ... https://docs.python.org/ja/3.7/library/unittest.html#unittest.TestCase.subTest
    ...
    def test_greeting_out_of_range_value(self):
        for hour in [-1, 24]:
            with self.subTest(msg='0以上24未満ではない整数値を入力した場合に ValueError を発生させる', hour=hour):
                self.assertRaises(ValueError, greeting.greeting(hour))